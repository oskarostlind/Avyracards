...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-[100] mx-auto max-w-2xl animate-in slide-in-from-bottom-4 fade-in duration-700">
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-900/95 p-6 shadow-2xl backdrop-blur-md sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="rounded-lg bg-blue-600 px-4 py-2 text-xs font-medium text-white hover:bg-blue-500 transition shadow-lg shadow-blue-500/20"
          >
            Godkänn alla
          </button>
        </div>
