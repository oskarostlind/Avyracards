    ...
    return (
      <main className="min-h-screen bg-nordic-primary text-nordic-secondary selection:bg-emerald-500/30 overflow-hidden">
        <div className="mx-auto flex max-w-6xl flex-col gap-24 px-4 pb-24 pt-24 md:px-8">
          ...
          <section className="py-12 md:py-24 border-t border-nordic-highlight/40/50">
            <div className="max-w-3xl mx-auto text-center space-y-12">
              <div className="space-y-6">
                  ...
                  <div className="text-lg md:text-xl text-nordic-highlight space-y-2 leading-relaxed font-light">
                      <p>Ibland delar du <span className="text-nordic-secondary font-medium">LinkedIn</span>.</p>
                      <p>Ibland <span className="text-nordic-secondary font-medium">Instagram</span>.</p>
