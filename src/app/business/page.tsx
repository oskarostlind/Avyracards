      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-24 px-4 pb-24 pt-20 md:px-8">
        ...
        <section className="grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            ...
            <div className="flex flex-col gap-6">
                 <div className="flex flex-wrap gap-4">
                    <Link
                        ...
                        className="inline-flex items-center justify-center rounded-2xl bg-emerald-600 px-8 py-4 text-base font-bold text-white shadow-lg shadow-emerald-900/20 transition hover:bg-emerald-500 hover:scale-105 active:scale-95"
                    >
                        Skapa business-profil gratis
                    </Link>
                    <Link
                        href="#how-it-works"
                        className="inline-flex items-center justify-center rounded-2xl border border-slate-700 bg-transparent px-8 py-4 text-base font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition"
                    >
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end animate-in fade-in zoom-in duration-1000 delay-200">
             ...
             <div className="relative w-[320px] h-[640px] bg-slate-900 rounded-[3rem] border-[8px] border-slate-800 shadow-2xl overflow-hidden rotate-[2deg] hover:rotate-0 transition-transform duration-500">
               {/* Notch */}
               ...
               <div className="h-full w-full bg-slate-950 overflow-y-auto hide-scrollbar relative">
                 ...
                 <div className="px-6 relative -mt-20">
                   ...
                   <div className="mt-8">
                      <button className="w-full bg-white text-slate-950 h-14 rounded-xl font-bold shadow-lg shadow-white/5 flex items-center justify-center gap-3 transition-transform hover:scale-[1.02]">
                   ...
                   <div className="grid grid-cols-2 gap-3 mt-4">
                     <button className="bg-slate-900 h-12 rounded-xl text-slate-300 text-sm font-medium border border-slate-800 flex items-center justify-center gap-2 hover:bg-slate-800 hover:text-white transition-colors">
                       <Mail size={16}/> Maila
                     </button>
                     <button className="bg-slate-900 h-12 rounded-xl text-slate-300 text-sm font-medium border border-slate-800 flex items-center justify-center gap-2 hover:bg-slate-800 hover:text-white transition-colors">
                       <Phone size={16}/> Ring
                   ...
                   <div className="mt-8 space-y-3 pb-8">
                     <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800 flex items-center justify-between cursor-pointer hover:border-emerald-500/30 transition-colors group">
                     ...
                     <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800 flex items-center justify-between cursor-pointer hover:border-emerald-500/30 transition-colors group">
                       <div className="flex items-center gap-4">
                         <div className="h-10 w-10 rounded-lg bg-slate-800 text-slate-400 flex items-center justify-center font-bold">🌐</div>
          ...
          <div className="max-w-3xl mx-auto text-center space-y-12">
            <div className="space-y-6">
                ...
                <div className="text-lg md:text-xl text-slate-400 space-y-2 leading-relaxed font-light">
                    ...
                    <p className="pt-4 italic text-slate-500">Och när du väl delar – är det inte säkert att det leder någonstans.</p>
                </div>
            </div>
        ...
        <section className="bg-slate-900/30 rounded-[3rem] border border-slate-800 p-8 md:p-16 relative overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
                <div className="space-y-8">
                    ...
                    <ul className="space-y-6 text-lg text-slate-400">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <span className="text-white block font-medium">Dela kontaktuppgifter direkt</span>
                        ...
                        <li className="flex items-start gap-4">
                            <div className="h-6 w-6 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500 mt-1"><Layers size={14}/></div>
                             <div>
                                <span className="text-white block font-medium">Visa professionell info</span>
                        ...
                        <li className="flex items-start gap-4">
                            <div className="h-6 w-6 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500 mt-1"><ShieldCheck size={14}/></div>
                             <div>
                                <span className="text-white block font-medium">Alltid uppdaterat</span>
                ...
                <div className="relative h-[400px] w-full flex items-center justify-center">
                    <div className="absolute w-72 bg-slate-950 border border-slate-800 rounded-2xl shadow-2xl p-6 rotate-[-2deg] hover:rotate-0 transition-transform duration-500 z-10">
                        ...
                        <div className="mt-8 grid grid-cols-3 gap-2">
                             <div className="h-10 bg-slate-900 rounded-lg border border-slate-800"></div>
                             <div className="h-10 bg-slate-900 rounded-lg border border-slate-800"></div>
                             <div className="h-10 bg-slate-900 rounded-lg border border-slate-800"></div>
                        </div>
                        <div className="mt-4 h-12 bg-white rounded-lg w-full flex items-center justify-center">
                            <div className="h-2 w-24 bg-slate-300 rounded-full"></div>
                        </div>
                    </div>
                     {/* Bakgrundskort för djup */}
                     <div className="absolute w-72 h-64 bg-slate-900 border border-slate-800 rounded-2xl opacity-50 rotate-[4deg] scale-95 -z-0"></div>
                </div>
            </div>
        </section>
        ...
        <section id="how-it-works" className="py-12">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl font-bold text-white sm:text-4xl">Redo när mötet händer.</h2>
          </div>
        ...
        {/* --- 5. NFC BUSINESS CARD --- */}
        <section className="grid md:grid-cols-2 gap-12 items-center py-16 border-t border-slate-800/50">
            <div className="order-2 md:order-1">
                <div className="relative w-full aspect-video bg-gradient-to-br from-slate-950 to-slate-900 rounded-3xl border border-slate-800 flex items-center justify-center overflow-hidden group">
                     ...
                     <div className="w-64 h-40 bg-gradient-to-br from-slate-800 to-black rounded-xl shadow-2xl transform rotate-[-6deg] group-hover:rotate-0 transition-all duration-700 flex flex-col justify-between p-6 border border-slate-700/50">
                        <div className="flex justify-between items-start">
                             <div className="h-8 w-8 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center font-serif text-white/50 text-xs">A</div>
                             <div className="text-[10px] text-white/30 tracking-widest uppercase font-mono">Business</div>
                        </div>
                        <div className="text-right">
                            <div className="text-white/20 text-xs font-mono">Erik Svensson</div>
                        </div>
                     </div>
                </div>
            </div>
            <div className="space-y-8 order-1 md:order-2">
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ett kort som representerar dig.</h2>
                ...
                <button className="text-white border-b border-white pb-0.5 hover:text-emerald-400 hover:border-emerald-400 transition-colors text-sm font-medium">
        ...
        <section className="py-16 grid md:grid-cols-2 gap-12 items-center">
             <div className="space-y-6">
                ...
                <h2 className="text-3xl font-bold text-white">Följ upp dina kontakter</h2>
             ...
             <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8">
                 ...
                 <div className="space-y-6">
                     <div className="flex justify-between items-center">
                         <h4 className="text-white font-bold">Översikt</h4>
                         <select className="bg-slate-800 text-xs text-slate-300 rounded px-2 py-1 border border-slate-700 outline-none">
                             <option>Senaste 30 dagar</option>
                         </select>
                     </div>
                     <div className="grid grid-cols-2 gap-4">
                         <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                             <div className="text-xs text-slate-500 mb-1">Visningar</div>
                         ...
                         <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                             <div className="text-xs text-slate-500 mb-1">Sparade kontakter</div>
                             <div className="text-2xl font-mono text-white">86</div>
                             <div className="text-xs text-emerald-400 mt-1 flex items-center gap-1">▲ 5%</div>
                         </div>
                     </div>
                     {/* Bars */}
                     <div className="flex items-end gap-2 h-24 pt-4 border-t border-slate-800/50">
        ...
        <section className="text-center max-w-2xl mx-auto py-12 space-y-6">
             ...
             <h2 className="text-3xl font-bold text-white">Håll isär jobb och privat.</h2>
        ...
        <section className="relative overflow-hidden rounded-[3rem] bg-gradient-to-b from-slate-900 to-slate-950 border border-emerald-900/30 p-12 md:p-24 text-center mt-8">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/register?mode=business"
                className="inline-flex h-14 items-center justify-center rounded-2xl bg-emerald-600 px-10 text-base font-bold text-white shadow-xl shadow-emerald-900/20 transition-all hover:bg-emerald-500 hover:scale-105"
              >
                Skapa business-profil gratis
              </Link>
            </div>
            ...
            <div className="pt-12 flex justify-center gap-6 text-sm text-slate-500 border-t border-slate-800/50 w-fit mx-auto mt-8 px-8">
               ...
               <Link href="/" className="hover:text-white transition-colors">För privatpersoner</Link>
               <span className="text-slate-700">•</span>
